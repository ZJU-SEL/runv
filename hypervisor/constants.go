...
const (
	...
	EVENT_TTY_OPEN
	EVENT_TTY_CLOSE
	EVENT_MIGRATE_OUT_TIMEOUT
	EVENT_WAIT_MIGRATE_OUT
	COMMAND_CHECKPOINT_VM
	COMMAND_RESTORE_VM
	COMMAND_RESUME_VM
	COMMAND_MIGRATE_VM
	COMMAND_GET_POD_IP
...
func EventString(ev int) string {
	...
	case EVENT_VM_PAUSE:
		return "EVENT_VM_PAUSE"
	case EVENT_VM_RESUME:
		return "EVENT_VM_RESUME"
	...
	case EVENT_MIGRATE_OUT_TIMEOUT:
		return "EVENT_MIGRATE_OUT_TIMEOUT"
	case EVENT_WAIT_MIGRATE_OUT:
		return "EVENT_WAIT_MIGRATE_OUT"
	case COMMAND_CHECKPOINT_VM:
		return "COMMAND_CHECKPOINT_VM"
	case COMMAND_RESTORE_VM:
		return "COMMAND_RESTORE_VM"
	case COMMAND_RESUME_VM:
		return "COMMAND_RESUME_VM"
	case COMMAND_MIGRATE_VM:
		return "COMMAND_MIGRATE_VM"
